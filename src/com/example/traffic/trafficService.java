...
{	
		...
		handler = new Handler() 
			{
			    ...
			    public void handleMessage(Message msg) {
			        ...
			        {			        	
						updateTraffic();
						notification("traffic has updated | UID : " + String.valueOf(uid), "更新流量");
					} 
			        catch (Exception e)
			        {
						// TODO: handle exception
			        	notification("traffic update error", "更新流量");
					}
	...
	{		
		...
		try 
		{
			...
			notification("traffic service is running", "service is running in the background");							
